  ...
  if (!isClient) {
    return (
      <header
        className={ cn(
          `
            sticky top-0 z-60 flex h-16 shrink-0 flex-row items-center justify-between gap-2 bg-background transition-[width,height]
            ease-linear
  ...
  return (
    <header
      className={ cn(
        ...
        `,
        {
          'kq-light-shadow border-b-1': hasScrolled,
        },
      ) }
    >
      { children }
