    ...
    <MenubarPrimitive.Trigger
      ...
      className={ cn(
        `
          ...
          flex select-none items-center rounded-sm px-2 py-1 text-sm font-medium
        `,
        className,
      ) }
      { ...props }
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={ cn(
          `
            origin-(--radix-menubar-content-transform-origin) bg-popover text-popover-foreground
    ...
    <MenubarPrimitive.CheckboxItem
      ...
      className={ cn(
        `
          ...
          focus:bg-accent focus:text-accent-foreground
          relative flex cursor-default select-none items-center gap-2 py-1.5 pl-8 pr-2 text-sm
