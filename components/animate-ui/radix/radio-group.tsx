...
function RadioGroupItem({ className, transition = { type: 'spring', stiffness: 200, damping: 16 }, ...props }: RadioGroupItemProps) {
  return (
    <RadioGroupPrimitive.Item asChild { ...props }>
      <motion.button
        ...
        className={ cn(
          `
            flex aspect-square size-5 items-center justify-center rounded-full border border-input text-primary ring-offset-background
            focus:outline-none
