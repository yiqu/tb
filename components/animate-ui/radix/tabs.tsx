  ...
  return (
    ...
    >
      <TabsPrimitive.List
        ref={ localRef }
        data-slot="tabs-list"
        className={ cn('inline-flex h-10 w-fit items-center justify-center rounded-lg bg-muted p-[4px] text-muted-foreground', className) }
        { ...props }
      >
        { children }
      </TabsPrimitive.List>
  ...
  return (
    <MotionHighlightItem value={ value } className="size-full">
      <TabsPrimitive.Trigger
        ...
        className={ cn(
          `
            z-[1] inline-flex size-full cursor-pointer items-center justify-center rounded-sm px-2 py-1 text-sm
