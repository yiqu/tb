  ...
  if (asChild) {
    if (mode === 'children') {
      return React.cloneElement(
        ...
        <>
          <AnimatePresence initial={ false }>
            { isActive && !isDisabled ? <motion.div
...
export { MotionHighlight, useMotionHighlight, MotionHighlightItem, type MotionHighlightProps, type MotionHighlightItemProps };
