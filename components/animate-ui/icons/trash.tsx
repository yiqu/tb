  ...
  return (
    ...
    >
      <motion.g variants={ variants.group } initial="initial" animate={ controls }>
        <motion.path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" variants={ variants.path1 } initial="initial" animate={ controls } />
        <motion.path d="M3 6h18" variants={ variants.path2 } initial="initial" animate={ controls } />
      </motion.g>
      <motion.path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" variants={ variants.path3 } initial="initial" animate={ controls } />
    </motion.svg>
  );
}
...
export { Trash, animations, type TrashProps, Trash as TrashIcon, type TrashProps as TrashIconProps };
