...
import { useAnimation, type Variants, SVGMotionProps, type LegacyAnimationControls } from 'motion/react';
...
interface IconProps<T> extends DefaultIconProps<T>, Omit<SVGMotionProps<SVGSVGElement>, 'animate' | 'onAnimationStart' | 'onAnimationEnd'> {
  size?: number;
}
