...
export const ShimmerButton = React.forwardRef<HTMLButtonElement, ShimmerButtonProps>(
  (
    ...
    return (
      <button
        ...
        className={ cn(
          `
            ...
            border border-white/10 px-6 py-3 whitespace-nowrap text-white
            [background:var(--bg)]
            dark:text-black
          `,
          `
      ...
      >
        { /* spark container */ }
        <div className={ cn('-z-30 blur-[2px]', `
          [container-type:size]
          absolute inset-0 overflow-visible
        `) }>
          { /* spark */ }
          <div className={ `
            animate-shimmer-slide absolute inset-0
            [aspect-ratio:1]
            h-[100cqh]
            [border-radius:0]
            [mask:none]
          ` }>
            { /* spark before */ }
            <div className={ `
              animate-spin-around absolute -inset-full w-auto
              [translate:0_0]
              rotate-0
