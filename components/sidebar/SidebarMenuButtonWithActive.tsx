...
export default function SidebarMenuButtonWithActive({ item }: { item: LeftNavItem } & VariantProps<typeof sidebarMenuButtonVariants>) {
  ...
  return (
    <SidebarMenuButton asChild tooltip={ item.tooltip } isActive={ isActive }>
      <Link href={ `/${item.url}` as any } prefetch={ true }>
