...
import OutstandingBillsTablePaginationPageCountSelectList from './OutstandingBillsTablePaginationPageCountSelectList';

export default function OutstandingBillsTablePaginationPageCountSelect({ children }: { children: ReactNode }) {
    ...
    <Popover>
      ...
      <PopoverContent className="flex w-full flex-col gap-y-2">
        ...
        <Suspense fallback={ <BillsTablePaginationPageCountSelectSkeleton /> }>
          <OutstandingBillsTablePaginationPageCountSelectList paginationPromise={ paginationPromise } />
        </Suspense>
      </PopoverContent>
    </Popover>
  );
